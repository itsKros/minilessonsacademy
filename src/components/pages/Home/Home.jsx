  ...
  return (
    <>
      ...
      <section className="py-10">
        ...
        <div className="max-w-7xl mx-auto mt-[-30px] flex flex-wrap gap-10 items-center justify-center">
          {/* Image */}
          <img
            alt="content"
    ...
    `,
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap gap-10 ">
          <h2 className="max-w-[450px] mx-auto  text-center w-full mb-10 font-bold font-bold text-black text-[50px] leading-[65px]"><span class="text-[#9b0ff1]">Real Results</span> From Creators Like You</h2>
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap gap-10 ">
          <h3 className="w-full max-w-[600px] mx-auto text-center font-bold text-[50px] leading-[60px] text-transparent bg-clip-text bg-[linear-gradient(180deg,_#9B0FF1_0%,_#4A0773_100%)]">Mini Lessons Academy Helps You Create:</h3>
          <div class="w-full max-w-[750px] mx-auto space-y-4  ">
            <p class="flex gap-2 font-medium text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" /> <span class="font-bold">Lead magnets that convert</span> visitors to subscribers</p>
            <p class="flex gap-2 font-medium text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" /><span class="font-bold">E-books that establish</span> your authority</p>
            <p class="flex gap-2 font-medium text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" /><span class="font-bold">Courses that generate</span> passive income</p>
            <p class="flex gap-2 font-medium text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" /><span class="font-bold">Audiobooks that reach </span> busy learners</p>
            <p class="flex gap-2 font-medium text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" /><span class="font-bold">Workshop materials</span> that impress clients</p>
            <p class="flex gap-2 font-bold text-black text-[28px] leading-[26px]"><img class="w-7 h-7" src="/assets/home/greenCheck.svg" />And much more…</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap gap-10 ">
          <h2 className="max-w-[700px] mx-auto text-center w-full mb-5 font-bold font-bold text-black text-[50px] leading-[65px]">What Makes <span class="text-[#9b0ff1]">Mini Lessons Academy </span> Different</h2>
          ...
          <div class="max-w-[900px] mx-auto my-[-150px] flex items-center gap-5">
            <div class="p-4 md:w-1/2 w-full">
              <div class="h-full p-8">
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap gap-5">
          ...
          <h3 className="mx-auto text-center w-full font-bold font-bold text-black text-[50px] leading-[65px]">“I Built a Course… <br />Now, How Do I Market it?”</h3>
        ...
        <div class="max-w-[600px] mx-auto flex flex-wrap flex-col -m-4 items-start">
          <div class="p-4 max-w-[600px]">
            <div class="h-full flex sm:flex-row flex-col sm:text-left">
              <img alt="team" class="w-18 h-18" src="/assets/home/icon-4.png" />
          ...
          <div class="p-4 max-w-[600px]">
            <div class="h-full flex sm:flex-row flex-col sm:text-left">
              <img alt="team" class="w-18 h-18" src="/assets/home/icon-5.png" />
              <div class="flex-grow sm:pl-8">
          ...
          <div class="p-4 max-w-[600px]">
            <div class="h-full flex sm:flex-row flex-col sm:text-left">
              <img alt="team" class="w-18 h-18" src="/assets/home/icon-6.png" />
              <div class="flex-grow sm:pl-8">
      ...
      {/* Sectione 13 FAQ*/}
      <section class="py-10 bg-[linear-gradient(90deg,_#FFF9E1_0%,_#FFEDED_30.94%,_#EDF1FF_62.22%,_#FFFFFF_92.31%)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap gap-5">
          <h3 class="w-full max-w-[1100px] mx-auto text-center font-bold text-[60px] leading-[70px] text-transparent bg-clip-text bg-[linear-gradient(180deg,_#9B0FF1_0%,_#4A0773_100%)]">70% of Six-Figure Creators Say Courses Are Their #1 Income Source</h3>
          <div className="w-full mx-auto flex gap-0">
            {/* Left Image Block */}
