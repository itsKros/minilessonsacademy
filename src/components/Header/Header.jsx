...
export default function Header() {
  ...
  return (
    <header className="w-full border-b border-gray-200 bg-white font-poppins relative z-50">
      ...
      >
        <div
          className={`fixed right-0 top-0 z-50 h-full w-[330px] bg-white shadow-lg px-5 py-6 transform transition-transform duration-600 ease-in-out ${sidebarOpen ? "translate-x-0" : "translate-x-full"
            }`} 
